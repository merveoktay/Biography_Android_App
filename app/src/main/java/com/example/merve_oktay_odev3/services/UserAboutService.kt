...
class UserAboutService {
    fun  userAboutData():UserAbout
    {
        val  about="Ben Merve OKTAY. Android programlama üzerine kendimi geliştiriyorum. Çeşitli alanlarda projerler yapma imkanım oldu. " +
                "Üniversitede görüntü işleme projesi, yapay sinir ağları ile görüntü üzerinde sınıflandırma ve doğal dil işleme projeleri geliştirdim."+
                "Üniversiteden sonra java ve C# eğitimleri aldım. Bu eğitimlerde .Net projeleri geliştirdim." +
                " Aldığım eğitimler ve yapltığım projerler sonrasında Android uygulama geliştirmenin benim için daha iyi olduğuna ve severek öğrendime kanaat getirdiğim için bu alanda ilerlemeye karar verdim."
